...
pub trait ANTLRErrorStrategy {
    ...
    /// 
    fn recover_inline(&mut self, recognizer: Parser) -> Result<Token, RecognitionError>
    ...
    /// the parsing process
    /// 
    fn sync(&mut self, recognizer: Parser) -> Result<(), RecognitionError>;
