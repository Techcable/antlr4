...
open class LexerATNSimulator: ATNSimulator {
    ...
    /// 
    public var char_position_in_line = 0
    ...
    internal func accept(_ input: CharStream, _ lexerActionExecutor: LexerActionExecutor?,
        _ startIndex: Int, _ index: Int, _ line: Int, _ charPos: Int) throws {
            ...
            self.line = line
            self.char_position_in_line = charPos
            //TODO: CHECK
    ...
    final func evaluatePredicate(_ input: CharStream, _ ruleIndex: Int, _ predIndex: Int, _ speculative: Bool) throws -> Bool {
        ...
        var savedCharPositionInLine = char_position_in_line
        var savedLine = line
        ...
        do {
            ...
            defer
            {
                char_position_in_line = savedCharPositionInLine
                line = savedLine
                try! input.seek(index)
    ...
    final func captureSimState(_ settings: SimState,
        ...
        _ dfaState: DFAState) {
            ...
            settings.line = line
            settings.charPos = char_position_in_line
    ...
    public func setCharPositionInLine(_ char_position_in_line: Int) {
